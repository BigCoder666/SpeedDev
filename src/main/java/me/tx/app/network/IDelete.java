...
public abstract class IDelete implements IResponse {
    ...
    public IDelete(BaseActivity activity){
    ...
    public IDelete(BaseActivity activity, boolean needLoad){
        this.activity = activity;
    ...
    public HttpBuilder.REQUEST_TYPE getRequestType(){
        return HttpBuilder.REQUEST_TYPE.DELETE;
    }
}
