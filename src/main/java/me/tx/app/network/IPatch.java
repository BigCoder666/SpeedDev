...
public abstract class IPatch implements IResponse {
    ...
    public IPatch(BaseActivity activity){
    ...
    public IPatch(BaseActivity activity, boolean needLoad){
        this.activity = activity;
    ...
    public HttpBuilder.REQUEST_TYPE getRequestType(){
        return HttpBuilder.REQUEST_TYPE.PATCH;
    }
}
